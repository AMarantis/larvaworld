...
from larvaworld.lib.plot.base import BasePlot, AutoBasePlot, GridPlot, _ensure_matplotlib_config
...
class TestBasePlotInitialization:
    ...
    def test_baseplot_save_as_overrides_name(self):
        ...
        plot = BasePlot(name="ignored", pref="also_ignored", save_as="custom", suf="jpg")
