...
class TestPlotMeanAndRange:
    ...
    def test_plot_mean_and_range_with_label(self):
        ...
        plot_mean_and_range(x=x, mean=mean, lb=lb, ub=ub, axis=ax, color="red", label="Test")
    ...
    def test_plot_mean_and_range_with_color_mean(self):
        ...
        plot_mean_and_range(x=x, mean=mean, lb=lb, ub=ub, axis=ax, color="blue", color_mean="green")
...
class TestProcessPlot:
    ...
    def test_process_plot_with_save_to(self, tmp_path):
        ...
        result = process_plot(fig=fig, save_to=str(tmp_path), filename="output.png", return_fig=False)
    ...
    def test_process_plot_without_save_to(self):
        ...
        result = process_plot(fig=fig, save_to=None, filename="test.png", return_fig=False)
    ...
    def test_process_plot_return_fig_true(self, tmp_path):
        ...
        result = process_plot(fig=fig, save_to=str(tmp_path), filename="test.png", return_fig=True)
...
class TestDualHalfCircle:
    ...
    def test_dual_half_circle_basic(self):
        ...
        wedges = dual_half_circle(center=(0.5, 0.5), radius=0.05, angle=90, ax=ax, colors=('white', 'black'))
    ...
    def test_dual_half_circle_without_ax(self):
        ...
        wedges = dual_half_circle(center=(0, 0), radius=0.1, ax=None, colors=('red', 'blue'))
...
class TestDefineEndKs:
    ...
    def test_define_end_ks_invalid_mode_raises(self):
        ...
        with pytest.raises(ValueError, match="Provide parameter shortcuts or define a mode"):
